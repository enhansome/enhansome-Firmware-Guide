...
1. [Firmware Learning Resources](https://github.com/mikeroyal/Firmware-Guide#Firmware-learning-resources) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

2. [Firmware Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Firmware-Guide#Firmware-tools-libraries-and-frameworks) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

3. [Virtualization](https://github.com/mikeroyal/Firmware-Guide#virtualization) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

4. [File systems](https://github.com/mikeroyal/Firmware-Guide#file-systems) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

5. [Security Tools and Frameworks](https://github.com/mikeroyal/Firmware-Guide#security-tools-and-frameworks) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

6. [Networking](https://github.com/mikeroyal/Firmware-Guide#networking) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

7. [Assembly Development](https://github.com/mikeroyal/Firmware-Guide#assembly-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

8. [C/C++ Development](https://github.com/mikeroyal/Firmware-Guide#cc-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

9. [C# Development](https://github.com/mikeroyal/Firmware-Guide#c-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

10. [.NET Development](https://github.com/mikeroyal/Firmware-Guide#net-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

11. [Python Development](https://github.com/mikeroyal/Firmware-Guide#python-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

12. [Rust Development](https://github.com/mikeroyal/Firmware-Guide#rust-development) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23

# Awesome Firmware Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/Firmware-Guide#table-of-contents) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23
...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,158 | 🐛 108 | 🌐 C | 📅 2026-09-14 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 80 | 🐛 20 | 🌐 Rust | 📅 2026-08-18 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,158 | 🐛 108 | 🌐 C | 📅 2026-09-14, written in Rust.
...
[QMK Toolbox](https://github.com/qmk/qmk_toolbox) ⭐ 3,078 | 🐛 25 | 🌐 C# | 📅 2026-08-20 is a Toolbox companion for [QMK](https://qmk.fm/) Firmware. It provides a collection of flashing tools packaged into one app. It supports auto-detection and auto-flashing of firmware to keyboards.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,220 | 🐛 221 | 🌐 Rust | 📅 2026-09-11 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 75,478 | 🐛 1,955 | 🌐 Java | 📅 2026-09-11 is a software reverse engineering (SRE) framework developed by NSA's Research Directorate for NSA's cybersecurity mission. It helps analyze any malicious code and malware like viruses, and can give cybersecurity professionals a better understanding of potential vulnerabilities in their networks and systems.

[DataWave](https://github.com/NationalSecurityAgency/datawave) ⭐ 729 | 🐛 398 | 🌐 Java | 📅 2026-09-11 is an ingest/query framework that leverages [Apache Accumulo](https://accumulo.apache.org/) to provide fast, secure data access.

[Emissary](https://github.com/NationalSecurityAgency/emissary) ⭐ 316 | 🐛 22 | 🌐 Java | 📅 2026-09-14 is a P2P based data-driven workflow engine that runs in a heterogeneous possibly widely dispersed, multi-tiered P2P network of compute resources. Workflow itineraries are not pre-planned as in conventional workflow engines, but are discovered as more information is discovered about the data.
...
[Zuul](https://github.com/Netflix/zuul) ⭐ 14,077 | 🐛 14 | 🌐 Java | 📅 2026-09-11 is an [L7 application gateway](https://www.f5.com/services/resources/glossary/application-layer-gateway) that provides capabilities for dynamic routing, monitoring, resiliency, security, and more.

[Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,112 | 🐛 34 | 🌐 Go | 📅 2025-01-06 is a resiliency tool that helps applications tolerate random instance failures. It is fully integrated with [Spinnaker](https://www.spinnaker.io/), the continuous delivery platform. Chaos Monkey will work with any backend that Spinnaker supports (AWS, Google Compute Engine, Azure, Kubernetes, Cloud Foundry).

[Priam](https://github.com/Netflix/Priam) ⭐ 1,039 | 🐛 57 | 🌐 Java | 📅 2026-06-17 is a tool/process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,323 | 🐛 631 | 🌐 Go | 📅 2026-09-14 is an unsupervised, coverage-guided kernel fuzzer.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,333 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,461 | 🐛 1,139 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,597 | 🐛 48 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,269 | 🐛 7,846 | 🌐 C# | 📅 2026-09-14 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,236 | 🐛 1 | 🌐 C# | 📅 2026-09-12 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,063 | 🐛 177 | 🌐 C# | 📅 2026-09-14 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,319 | 🐛 3,896 | 🌐 C# | 📅 2026-09-14 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,119 | 🐛 29 | 🌐 Python | 📅 2026-09-14 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,642 | 🐛 335 | 🌐 Python | 📅 2026-09-11 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Bottle](https://github.com/bottlepy/bottle) ⭐ 8,789 | 🐛 291 | 🌐 Python | 📅 2026-09-06 is a fast, simple and lightweight [WSGI](https://www.wsgi.org/) micro web-framework for Python. It is distributed as a single file module and has no dependencies other than the [Python Standard Library](https://docs.python.org/library/).
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,148 | 🐛 442 | 🌐 Rust | 📅 2026-09-14 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,841 | 🐛 1,814 | 🌐 Rust | 📅 2026-09-14 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Rocket](https://github.com/SergioBenitez/Rocket) ⭐ 25,783 | 🐛 91 | 🌐 Rust | 📅 2025-12-28 is an async web framework for Rust with a focus on usability, security, extensibility, and speed.
...
[Servo](https://github.com/servo/servo) ⭐ 37,972 | 🐛 3,196 | 🌐 Rust | 📅 2026-09-14 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,343 | 🐛 396 | 🌐 Rust | 📅 2026-09-14 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,586 | 🐛 183 | 🌐 Rust | 📅 2026-09-11 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,141 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Firmware-Guide/pulls) ⭐ 167 | 🐛 0 | 🌐 C | 📅 2022-01-23.
