...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,134 | 🐛 110 | 🌐 C | 📅 2026-09-02 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 79 | 🐛 20 | 🌐 Rust | 📅 2026-08-18 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,134 | 🐛 110 | 🌐 C | 📅 2026-09-02, written in Rust.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,180 | 🐛 220 | 🌐 Rust | 📅 2026-09-01 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Ganeti](https://github.com/ganeti/ganeti) ⭐ 582 | 🐛 331 | 🌐 Python | 📅 2026-09-02 is a virtual machine cluster management tool built on top of existing virtualization technologies such as Xen or KVM and other open source software. Once installed, the tool assumes management of the virtual instances (Xen DomU).
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,405 | 🐛 407 | 🌐 Go | 📅 2026-09-02 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,249 | 🐛 1,924 | 🌐 Java | 📅 2026-09-01 is a software reverse engineering (SRE) framework developed by NSA's Research Directorate for NSA's cybersecurity mission. It helps analyze any malicious code and malware like viruses, and can give cybersecurity professionals a better understanding of potential vulnerabilities in their networks and systems.

[DataWave](https://github.com/NationalSecurityAgency/datawave) ⭐ 727 | 🐛 384 | 🌐 Java | 📅 2026-09-01 is an ingest/query framework that leverages [Apache Accumulo](https://accumulo.apache.org/) to provide fast, secure data access.
...
[Zuul](https://github.com/Netflix/zuul) ⭐ 14,067 | 🐛 13 | 🌐 Java | 📅 2026-09-01 is an [L7 application gateway](https://www.f5.com/services/resources/glossary/application-layer-gateway) that provides capabilities for dynamic routing, monitoring, resiliency, security, and more.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,313 | 🐛 629 | 🌐 Go | 📅 2026-09-02 is an unsupervised, coverage-guided kernel fuzzer.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,426 | 🐛 1,186 | 🌐 CMake | 📅 2026-08-31 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,245 | 🐛 7,679 | 🌐 C# | 📅 2026-09-02 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,232 | 🐛 3 | 🌐 C# | 📅 2026-08-28 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,996 | 🐛 180 | 🌐 C# | 📅 2026-09-01 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,315 | 🐛 3,853 | 🌐 C# | 📅 2026-09-02 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,447 | 🐛 1,655 | 🌐 Rust | 📅 2026-09-01 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,057 | 🐛 449 | 🌐 Rust | 📅 2026-08-31 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,297 | 🐛 242 | 🌐 Rust | 📅 2026-09-01 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,875 | 🐛 3,178 | 🌐 Rust | 📅 2026-09-02 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,328 | 🐛 395 | 🌐 Rust | 📅 2026-09-02 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,551 | 🐛 179 | 🌐 Rust | 📅 2026-09-02 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Simpleinfra](https://github.com/rust-lang/simpleinfra) ⭐ 176 | 🐛 69 | 🌐 HCL | 📅 2026-09-02 is rep that contains the tools and automation written by the Rust infrastructure team to manage our services. Using some of the tools in this repo require privileges only infra team members have.

[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,027 | 🐛 33 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
