...
1. [Firmware Learning Resources](https://github.com/mikeroyal/Firmware-Guide#Firmware-learning-resources) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

2. [Firmware Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Firmware-Guide#Firmware-tools-libraries-and-frameworks) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

3. [Virtualization](https://github.com/mikeroyal/Firmware-Guide#virtualization) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

4. [File systems](https://github.com/mikeroyal/Firmware-Guide#file-systems) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

5. [Security Tools and Frameworks](https://github.com/mikeroyal/Firmware-Guide#security-tools-and-frameworks) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

6. [Networking](https://github.com/mikeroyal/Firmware-Guide#networking) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

7. [Assembly Development](https://github.com/mikeroyal/Firmware-Guide#assembly-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

8. [C/C++ Development](https://github.com/mikeroyal/Firmware-Guide#cc-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

9. [C# Development](https://github.com/mikeroyal/Firmware-Guide#c-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

10. [.NET Development](https://github.com/mikeroyal/Firmware-Guide#net-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

11. [Python Development](https://github.com/mikeroyal/Firmware-Guide#python-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

12. [Rust Development](https://github.com/mikeroyal/Firmware-Guide#rust-development) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23

# Awesome Firmware Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/Firmware-Guide#table-of-contents) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23
...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,151 | 🐛 109 | 🌐 C | 📅 2026-09-10 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 80 | 🐛 20 | 🌐 Rust | 📅 2026-08-18 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,151 | 🐛 109 | 🌐 C | 📅 2026-09-10, written in Rust.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,209 | 🐛 223 | 🌐 Rust | 📅 2026-09-10 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,471 | 🐛 395 | 🌐 Go | 📅 2026-09-10 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,732 | 🐛 1,947 | 🌐 Java | 📅 2026-09-08 is a software reverse engineering (SRE) framework developed by NSA's Research Directorate for NSA's cybersecurity mission. It helps analyze any malicious code and malware like viruses, and can give cybersecurity professionals a better understanding of potential vulnerabilities in their networks and systems.

[DataWave](https://github.com/NationalSecurityAgency/datawave) ⭐ 728 | 🐛 399 | 🌐 Java | 📅 2026-09-10 is an ingest/query framework that leverages [Apache Accumulo](https://accumulo.apache.org/) to provide fast, secure data access.

[Emissary](https://github.com/NationalSecurityAgency/emissary) ⭐ 316 | 🐛 22 | 🌐 Java | 📅 2026-09-09 is a P2P based data-driven workflow engine that runs in a heterogeneous possibly widely dispersed, multi-tiered P2P network of compute resources. Workflow itineraries are not pre-planned as in conventional workflow engines, but are discovered as more information is discovered about the data.
...
[Zuul](https://github.com/Netflix/zuul) ⭐ 14,074 | 🐛 16 | 🌐 Java | 📅 2026-09-02 is an [L7 application gateway](https://www.f5.com/services/resources/glossary/application-layer-gateway) that provides capabilities for dynamic routing, monitoring, resiliency, security, and more.

[Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,107 | 🐛 34 | 🌐 Go | 📅 2025-01-06 is a resiliency tool that helps applications tolerate random instance failures. It is fully integrated with [Spinnaker](https://www.spinnaker.io/), the continuous delivery platform. Chaos Monkey will work with any backend that Spinnaker supports (AWS, Google Compute Engine, Azure, Kubernetes, Cloud Foundry).
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,320 | 🐛 629 | 🌐 Go | 📅 2026-09-09 is an unsupervised, coverage-guided kernel fuzzer.
...
[Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,573 | 🐛 117 | 🌐 Python | 📅 2026-01-21 was created to facilitate the task in web applications assessments and it is based on a simple concept: it replaces any reference to the FUZZ keyword by the value of a given payload.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,316 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,452 | 🐛 1,169 | 🌐 CMake | 📅 2026-09-10 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 24 | 🌐 TypeSpec | 📅 2026-08-31 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,211 | 🐛 80 | 🌐 Markdown | 📅 2026-09-01 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,260 | 🐛 7,774 | 🌐 C# | 📅 2026-09-10 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,238 | 🐛 3 | 🌐 C# | 📅 2026-09-09 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,042 | 🐛 171 | 🌐 C# | 📅 2026-09-09 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,321 | 🐛 3,921 | 🌐 C# | 📅 2026-09-10 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,628 | 🐛 341 | 🌐 Python | 📅 2026-09-09 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Apache Arrow](https://github.com/apache/arrow) ⭐ 17,094 | 🐛 2,591 | 🌐 C++ | 📅 2026-09-10 is a development platform for in-memory analytics. It contains a set of technologies that enable big data systems to process and move data fast. Arrow's libraries are available for C, C++, C#, Go, Java, JavaScript, MATLAB, Python, R, Ruby, and Rust.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,107 | 🐛 442 | 🌐 Rust | 📅 2026-09-10 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,839 | 🐛 1,808 | 🌐 Rust | 📅 2026-09-10 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,313 | 🐛 242 | 🌐 Rust | 📅 2026-09-09 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,950 | 🐛 3,193 | 🌐 Rust | 📅 2026-09-10 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,342 | 🐛 397 | 🌐 Rust | 📅 2026-09-10 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,571 | 🐛 182 | 🌐 Rust | 📅 2026-09-10 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,115 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Firmware-Guide/pulls) ⭐ 166 | 🐛 0 | 🌐 C | 📅 2022-01-23.
